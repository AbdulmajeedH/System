    ...
    <form action={formAction} className="space-y-4 max-w-2xl">
      ...
      <Card className="space-y-4">
        <FormField label={t.invoices.supplier} required error={state.fieldErrors?.supplierId}>
          <Select name="supplierId" defaultValue={initial?.supplierId ?? ""} required>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <Input name="invoiceNumber" dir="ltr" defaultValue={initial?.invoiceNumber} required />
          </FormField>
          <FormField label={t.invoices.invoiceDate} required error={state.fieldErrors?.invoiceDate}>
            <Input
              name="invoiceDate"
              type="date"
              defaultValue={initial?.invoiceDate ?? toDateInputValue()}
              required
            />
          </FormField>
        </div>
                ...
                <Select
                  ...
                  onChange={(e) => {
                    ...
                    updateLine(index, {
                      ...
                      unitPrice: selected?.currentPrice ?? line.unitPrice,
                    });
                  }}
                >
                  <option value="" disabled>
